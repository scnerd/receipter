<template>
  ...
  <v-select v-else v-model="modelValue.unit" :items="unitStore.units" item-title="name" item-value="id" label="name"
    ...
    <template v-slot:prepend-item>
      <v-list-item title="Create new unit">
        <template v-slot:append>
          <v-row>
            <v-col col="auto">
              <v-text-field v-model="newUnitName" placeholder="New unit name..."
                            :disabled="creatingUnit"></v-text-field>
            </v-col>
            <v-col>
